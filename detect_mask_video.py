...
while True:
    ...
    for (box, pred) in zip(locs, preds):
        ...
        cv2.imwrite(str(i) + '_faces.jpg', roi_color)
        img_pred = image.load_img(str(i) + '_faces.jpg', target_size=(150, 150))
        os.remove(str(i) + '_faces.jpg')
        ...
        # print(label)
        # if "No Mask" in label:
        #	mytext = "Sir, Please bear your Mask"
